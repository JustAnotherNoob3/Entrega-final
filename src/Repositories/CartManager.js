...
class CartManager {
    ...
    async deleteProduct(cartId, productId) {
        await this.#deleteProductWithCart(await this.getCartById(cartId), productId);
        
    }
    async #deleteProductWithCart(cart, productId) {
    ...
    async getQuantityOfProduct(cartId, productId) {
        return this.#getQuantityOfProductWithCart(await this.getCartById(cartId), productId);
        
    }
    async #getQuantityOfProductWithCart(cart, productId) {
    ...
    async cartBought(cartId, email){
        ...
        for(let i = 0; i < cart.products.length; i++){
            ...
            this.#deleteProductWithCart(cart, pid);
